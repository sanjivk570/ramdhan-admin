...
// import { productSchema, type ProductFormData } from "../validation/product.schema";
...
//                         <Input placeholder="e.g. Realme P1 5g" {...register("name")} />
//                         {fieldError("name") && <p className="text-sm text-destructive">{fieldError("name")}</p>}
//                     </div>

//                     <div className="space-y-2">
//                         <label className="text-sm font-medium">Slug *</label>
//                         <Input placeholder="realme-p1-5g" {...register("slug")} />
//                         {fieldError("slug") && <p className="text-sm text-destructive">{fieldError("slug")}</p>}
//                     </div>

//                     <div className="space-y-2">
//                         <label className="text-sm font-medium">SKU *</label>
//                         <Input placeholder="realme-p1-5g-sku" {...register("sku")} />
//                         {fieldError("sku") && <p className="text-sm text-destructive">{fieldError("sku")}</p>}
//                     </div>

//                     <div className="space-y-2 md:col-span-2">
//                         <label className="text-sm font-medium">Short Description</label>
//                         <Input placeholder="Short product summary" {...register("short_description")} />
//                         {fieldError("short_description") && <p className="text-sm text-destructive">{fieldError("short_description")}</p>}
//                     </div>

//                     <div className="space-y-2 md:col-span-2">
//                         <label className="text-sm font-medium">Description</label>
//                         <Textarea rows={5} placeholder="Full product description" {...register("description")} />
//                     </div>
...
//                                     onValueChange={(value) => field.onChange(Number(value))}
//                                 >
//                                     <SelectTrigger><SelectValue placeholder="Select tax class" /></SelectTrigger>
//                                     <SelectContent>
//                                         {taxClasses.map((item) => (
//                                             <SelectItem key={item.value} value={item.value}>{item.label}</SelectItem>
//                                         ))}
...
//                                                             : field.value.filter((id) => id !== category.value);
//                                                         field.onChange(next);
//                                                     }}
//                                                 />
//                                                 {category.label}
...
//                             )}
//                         />
//                         {fieldError("categories") && <p className="text-sm text-destructive">{fieldError("categories")}</p>}
//                     </div>
//                 </div>
//             </section>
...
//                     <p className="mt-1 text-sm text-muted-foreground">Customer price, comparison price and internal cost.</p>
//                 </div>
...
//                         {fieldError("price") && <p className="text-sm text-destructive">{fieldError("price")}</p>}
//                     </div>
//                     <div className="space-y-2">
...
//             <section className="overflow-hidden rounded-xl border bg-card shadow-sm">
//                 <div className="border-b bg-muted/20 px-6 py-4">
//                     <h2 className="text-base font-semibold">Inventory & Publishing</h2>
//                     <p className="mt-1 text-sm text-muted-foreground">Initial stock and product visibility settings.</p>
//                 </div>

//                 <div className="grid gap-5 p-6 md:grid-cols-4">
//                     <div className="space-y-2">
//                         <label className="text-sm font-medium">Stock Quantity *</label>
//                         <Input type="number" min="0" step="1" {...register("stock_quantity")} />
//                     </div>
//                     <div className="space-y-2">
//                         <label className="text-sm font-medium">Low Stock Threshold *</label>
//                         <Input type="number" min="0" step="1" {...register("low_stock_threshold")} />
//                     </div>
//                     <div className="space-y-2">
